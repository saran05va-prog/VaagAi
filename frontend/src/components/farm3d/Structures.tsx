  ...
  return (
    <group position={[-9.5, 0, -8.5]} rotation={[0, 0.4, 0]}>
      ...
      <mesh position={[0, 1.15, 0.85]}>
        ...
        <meshStandardMaterial color="#4A2E1A" roughness={0.7} />
      </mesh>
      <mesh position={[-0.5, 0.35, 0.85]}>
        <boxGeometry args={[0.5, 0.5, 0.05]} />
        <meshStandardMaterial color="#87CEEB" roughness={0.3} metalness={0.1} transparent opacity={0.7} />
      </mesh>
      <mesh position={[0.5, 0.35, 0.85]}>
        <boxGeometry args={[0.5, 0.5, 0.05]} />
        <meshStandardMaterial color="#87CEEB" roughness={0.3} metalness={0.1} transparent opacity={0.7} />
...
function WaterTank() {
  const refillRef = useRef<THREE.Mesh>(null)
  useFrame((state) => {
    if (refillRef.current) {
      const mat = refillRef.current.material as THREE.MeshStandardMaterial
      mat.emissiveIntensity = 0.15 + Math.sin(state.clock.elapsedTime * 2) * 0.05
    }
  })
  ...
  return (
    <group position={[7.5, 0, -7]}>
      <mesh position={[0, 0.1, 0]}>
        ...
        <meshStandardMaterial color="#616161" roughness={0.8} metalness={0.3} />
      </mesh>
      ...
      <mesh ref={refillRef} position={[0, 0.8, 0]}>
        <cylinderGeometry args={[0.57, 0.57, 0.05, 16]} />
        <meshStandardMaterial color="#1E88E5" emissive="#42A5F5" emissiveIntensity={0.15} transparent opacity={0.5} />
      </mesh>
      <mesh position={[0, 1.5, 0]}>
        <coneGeometry args={[0.55, 0.2, 16]} />
  ...
  return (
    <group position={[5.5, 0, -9]}>
      <mesh position={[0, 0.3, 0]} castShadow>
        <cylinderGeometry args={[0.4, 0.45, 0.6, 16]} />
        <meshStandardMaterial color="#795548" roughness={0.9} />
      </mesh>
      <mesh position={[0, 0.62, 0]}>
        <cylinderGeometry args={[0.35, 0.35, 0.05, 16]} />
        <meshStandardMaterial color="#1565C0" roughness={0.1} metalness={0.2} transparent opacity={0.7} />
      </mesh>
  ...
  return (
    <group ref={ref} position={[-6, 0, 7]}>
      ...
      <mesh position={[0, 0.75, 0.3]}>
        ...
        <meshStandardMaterial color="#1B5E20" roughness={0.6} transparent opacity={0.4} />
      </mesh>
      <mesh position={[0.35, 0.2, -0.5]} rotation={[Math.PI / 2, 0, 0]}>
      ...
      <mesh position={[0.4, 0.15, 0.5]} rotation={[Math.PI / 2, 0, 0]}>
      ...
      <mesh position={[-0.2, 0.5, -0.7]} rotation={[0.3, 0, 0]}>
