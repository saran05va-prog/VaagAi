    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        ...
        {tab === 'signup' && step === 'farm' ? (
          ...
          <form onSubmit={tab === 'login' ? handleLogin : handleSignup} className="px-6 pb-0 space-y-3">
            {error && (
        ...
        <div className="px-6 pb-6 space-y-3">
          ...
          <button type="button" onClick={() => window.location.href = `${import.meta.env.VITE_API_URL || 'http://localhost:3002'}/api/auth/google`}
            ...
            style={{ background: 'rgba(255,255,255,0.08)', color: '#eefdf0', border: '1px solid rgba(255,255,255,0.15)' }}>
